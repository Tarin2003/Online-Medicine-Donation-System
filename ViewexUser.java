 ...
 * @author Hp
 */
public class ViewexUser extends JFrame{
    private Container c;
   ...
   Font font2 = new Font("Arial",Font.BOLD,18);
         Font font3 = new Font("Arial",Font.BOLD,20);
          String[] column ={"Name","Gender","Date of Birth","Email","Contact Number","Location"};
         ...
         header.setEnabled(false);
          ...
          TableColumn c1 = col.getColumn(0);
           ...
           c1.setPreferredWidth(400);
            c2.setPreferredWidth(460);
            c3.setPreferredWidth(130);
             c4.setPreferredWidth(450);
        ...
        try {
            ...
            String sql = "SELECT  `Name`, `Gender`, `Date of Birth`, `Email`, `Contact Number`, `Location`  FROM `executive` ";
          ...
          while(rs.next()){
               ...
               String n [] = {rs.getString("Name"), rs.getString("Gender"),rs.getString("Date of Birth"),rs.getString("Email"),rs.getString("Contact Number"),rs.getString("Location")};
               model.addRow(n);
