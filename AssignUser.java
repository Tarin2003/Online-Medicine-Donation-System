       ...
       c.add(title1);
        ...
        try {
          ...
          while(rs.next()){
               ...
               String n [] = {rs.getString("ID"),rs.getString("Name"), rs.getString("Gender"),rs.getString("Age"),rs.getString("Email"),rs.getString("Contact Number"),rs.getString("Location")};
               model.addRow(n);
